...
public class BadRequestException extends Exception {
    ...
    public BadRequestException(JSONObject data) {
        super(data.toString());
        this.data = data;
    }

    public BadRequestException(JSONObject data, Throwable cause) {
        super(data.toString(), cause);
        this.data = data;
    }

    public BadRequestException(TPPMessage.CodeEnum code, String message) {
        super(message);
    ...
    public BadRequestException(TPPMessage.CodeEnum code, String message, Throwable cause) {
        super(message, cause);
        this.data = ErrorUtil.constructBerlinError(
                null, TPPMessage.CategoryEnum.ERROR, code,
                message);
