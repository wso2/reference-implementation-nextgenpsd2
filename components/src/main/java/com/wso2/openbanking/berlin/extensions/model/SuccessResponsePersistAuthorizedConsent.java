...
import com.wso2.openbanking.berlin.extensions.model.SuccessResponsePersistAuthorizedConsentData;
...
public class SuccessResponsePersistAuthorizedConsent   {
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("data")
  @Valid public SuccessResponsePersistAuthorizedConsentData getData() {
    return data;
  }
