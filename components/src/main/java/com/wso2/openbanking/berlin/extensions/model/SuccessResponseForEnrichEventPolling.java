...
import com.wso2.openbanking.berlin.extensions.model.SuccessResponseForEnrichEventPollingData;
...
public class SuccessResponseForEnrichEventPolling   {
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("data")
  @Valid public SuccessResponseForEnrichEventPollingData getData() {
    return data;
  }
