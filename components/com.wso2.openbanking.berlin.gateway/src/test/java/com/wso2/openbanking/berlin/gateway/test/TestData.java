...
public class TestData {
    ...
    public static final Map<String, String> validAccountsRequestHeadersMap = new HashMap<String, String>() {{
       ...
       put("Signature", "keyId=\"SN=de730ec5733ead1b,CA=1.2.840.113549.1.9.1=#16116d616c7368616e694077736f322e636f6d," +
