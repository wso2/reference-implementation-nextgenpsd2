...
/**
 * Non-Regulatory Flow with Password Grant Type.
 */
class EndToEndFlowWithPasswordGrantTypeTest extends AbstractNonRegulatoryFlow {


    @Test
    void "Non-Regulatory with Password Grant Type: Token Generation"() {
        getUserTokenFromPasswordGrantType()
        Assert.assertNotNull(userAccessToken)

    }

    @Test(dependsOnMethods = "Non-Regulatory with Password Grant Type: Token Generation")
    void "TC1803012_Non-Regulatory with Password Grant Type: API Invocation"() {
        doApiInvocation()
