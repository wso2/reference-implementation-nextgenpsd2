...
class PaymentsDataProviders {
    ...
    Object[][] getPaymentsTypes() {
        ...
        PaymentsTypesList.add([PaymentsConstants.SINGLE_PAYMENTS_CONSENT_PATH,
                               [PaymentsConstants.PAYMENT_PRODUCT_SEPA_CREDIT_TRANSFERS],
                               PaymentsInitiationPayloads.singlePaymentPayload] as Object[])

        PaymentsTypesList.add([PaymentsConstants.BULK_PAYMENTS_CONSENT_PATH,
                               [PaymentsConstants.PAYMENT_PRODUCT_SEPA_CREDIT_TRANSFERS],
                               PaymentsInitiationPayloads.bulkPaymentPayload] as Object[])

        PaymentsTypesList.add([PaymentsConstants.PERIODIC_PAYMENTS_CONSENT_PATH,
                               [PaymentsConstants.PAYMENT_PRODUCT_SEPA_CREDIT_TRANSFERS],
    ...
    static Iterator<Object[]> getExplicitAuthorizationData() {
        ...
        periodicPaymentExplicitAuthDataMap.put("consentPath", PaymentsConstants.PERIODIC_PAYMENTS_CONSENT_PATH + "/" +
                PaymentsConstants.PAYMENT_PRODUCT_SEPA_CREDIT_TRANSFERS)
